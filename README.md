...
1. claude 기반 MCP 서버입니다. 처음 질문을 할 때 원하는 형태가 있다면 함께 적어주시는게 적절한 답변을 받기 좋습니다
(ex: 제일 마지막에 결과를 요약한 pdf파일을 생성해줘.)

2. 각 메이트를 하나씩 사용했을 때 토큰을 절약할 수 있습니다. 또한 원하는 답변이 나오지 않았을 때 질문을 수정하기 용이하며 더욱 자세한 답변을 받을 수 있습니다

3. 질문 템플릿 외에 각 메이트가 고려해야하는 정보가 있다면 추가하시는게 좋습니다
